  ...
  <body>
      ...
      <div class="row">
        <div class="col">
          <div class="jumbotron">
            ...
            <p class="lead">Realize o Login Na nossa Pagina, para que assim possa ter acesso as nossas aulas !</p>
            <hr class="my-4">
          </div>
            ...
            <form action="" method="POST">
              ...
              <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                  <button class="btn btn-outline-primary me-2" type="submit">Conectar</button>
                </div>
            </form>
        </div>
      </div>
    ...
    <?php
      ...
      if (isset($_POST['email'])){
        ...
        $query ="SELECT id,nome,endereco,data_nasc,telefone,email,senha,caminho,identificador FROM usuario WHERE email = '$email' AND senha = '$senha'";
        ...
        if ($conectou == 1){
          ...
          $_SESSION['caminho'] = $usuario["caminho"];
    ...
    <script src="//cdn.jsdelivr.net/npm/@popperjs/core@2.9.3/dist/umd/popper.min.js" integrity="sha384-W8fXfP3gkOKtndU4JGtKDvXbO53Wy8SZCQHczT5FMiiqmQfUpWbYdTil/SxwZgAN" crossorigin="anonymous"></script>
    <script src="//cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.min.js" integrity="sha384-skAcpIdS7UcVUC05LJ9Dxay8AXcDYfBJqt1CJ85S/CFujBsIzCIv+l9liuYLaMQ/" crossorigin="anonymous"></script>
